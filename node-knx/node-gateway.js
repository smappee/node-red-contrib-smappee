...
module.exports = function (RED) {
  ...
  function GatewayConfigNode (config) {
    ...
    node.subscribe = (handler, criteria) => node.gateway.subscribe(handler, criteria)
    node.publish = (source, payload, bitLength, callback) => node.gateway.publish(source, payload, bitLength, callback)
  }
